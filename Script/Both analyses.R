...
ugLL <- raster::raster("Data_map/Rasters/water_table_1958_LL.tif")
ugUL <- raster::raster("Data_map/Rasters/water_table_1958_UL.tif")
ugUR <- raster::raster("Data_map/Rasters/water_table_1958_UR.tif")
ugLR <- raster::raster("Data_map/Rasters/water_table_1958_LR.tif")
